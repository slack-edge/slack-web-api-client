...
export type FunctionsDistributionsPermissionsAddResponse =
  FunctionsDistributionsPermissionsResponse;
export type FunctionsDistributionsPermissionsListResponse =
  FunctionsDistributionsPermissionsResponse;
export type FunctionsDistributionsPermissionsRemoveResponse =
  FunctionsDistributionsPermissionsResponse;
